...
void main()
{
    ...
    for (int i = 0; i < num_lines; i++) {
        ...
        float target_y = params_i.radius_base + params_i.radius_scale * data_interp;

        float target_y_floor = params_i.radius_base + params_i.radius_scale * data_floor;
        float target_y_ceil = params_i.radius_base + params_i.radius_scale * data_ceil;

        // float err = coord[1] - params_i.radius_base;
        // if (err < 0){
        ...
        if (close_enough && not_over && not_under) {
